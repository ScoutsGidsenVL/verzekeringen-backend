...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('non_member', models.OneToOneField(db_constraint=django.db.models.constraints.UniqueConstraint, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='people.inuitsnonmember')),
                ('editable', models.BooleanField(default=True)),
                ('travel_assistance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='template', to='scouts_insurances.participanttravelassistanceinsurance')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('non_member', models.OneToOneField(db_constraint=django.db.models.constraints.UniqueConstraint, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='people.inuitsnonmember')),
                ('editable', models.BooleanField(default=True)),
                ('temporary_vehicle_insurance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='template', to='scouts_insurances.participanttemporaryvehicleinsurance')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('non_member', models.OneToOneField(db_constraint=django.db.models.constraints.UniqueConstraint, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='people.inuitsnonmember')),
                ('editable', models.BooleanField(default=True)),
                ('temporary_insurance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='template', to='scouts_insurances.nonmembertemporaryinsurance')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('non_member', models.OneToOneField(db_constraint=django.db.models.constraints.UniqueConstraint, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='people.inuitsnonmember')),
                ('editable', models.BooleanField(default=True)),
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='template', to='scouts_insurances.equipment')),
            ],
        ),
    ]
