...
class EmailService:
    ...
    def _add_in_blue_attachments(self, attachments: list = None):
        """Returns a JSON with name and content values required for SendInBlue.
        """
        ...
        for attachment in attachments:
            ...
            data.append({"name": name, "content": base64.b64encode(content)})
