...
from scouts_auth.inuits.models import Gender, InuitsAddress, InuitsCountry, InuitsPerson, InuitsPersonalDetails
...
class InuitsPersonService:
    ...
    def inuits_address_details_create(
        ...
        address_details = InuitsAddress(
            street=street, number=number, letter_box=letter_box, postal_code=postal_code, city=city, country=country
        )
