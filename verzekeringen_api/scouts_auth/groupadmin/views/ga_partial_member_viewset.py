...
from scouts_auth.groupadmin.models import ScoutsMemberSearchResponse
from scouts_auth.groupadmin.serializers import ScoutsMemberSearchResponseSerializer
...
class ScoutsPartialMemberView(viewsets.ViewSet):
    ...
    @swagger_auto_schema(responses={status.HTTP_200_OK: ScoutsMemberSearchResponseSerializer})
    @action(
        methods=["GET"],
    ...
    def view_member_search(self, request, query: str):
        ...
        members: List[ScoutsMemberSearchResponse] = self.service.search_member(request.user, query)
    ...
    def view_member_similar_search(self, request, first_name: str, last_name: str):
        ...
        members: List[ScoutsMemberSearchResponse] = self.service.search_similar_members(
