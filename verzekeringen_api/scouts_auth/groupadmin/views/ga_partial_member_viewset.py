...
class ScoutsPartialMemberView(viewsets.ViewSet):
    ...
    @swagger_auto_schema(responses={status.HTTP_200_OK: AbstractScoutsMemberSearchResponseSerializer})
    @action(
        methods=["GET"],
    ...
    def view_member_search(self, request, query: str):
        ...
        members: List[AbstractScoutsMemberSearchResponse] = self.service.search_member(request.user, query)
    ...
    def view_member_similar_search(self, request, first_name: str, last_name: str):
        ...
        members: List[AbstractScoutsMemberSearchResponse] = self.service.search_similar_members(
