...
from scouts_auth.models import GroupAdminMember, PostcodeCity, GroupAdminAddress
...
class GroupAdminMemberService:
    ...
    def _parse_member_data(self, member_data: dict, group_admin_id: str) -> GroupAdminMember:
        try:
    ...
    def _parse_search_result(self, member_data) -> GroupAdminMember:
    ...
    def _parse_search_results(self, active_user, json, include_inactive: bool = False) -> List[GroupAdminMember]:
        results = []
