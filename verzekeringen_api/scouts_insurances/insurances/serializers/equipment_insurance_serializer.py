...
class EquipmentInsuranceSerializer(BaseInsuranceSerializer):
    ...
    class Meta:
        ...
        fields = BaseInsuranceFields + ["nature", "_country", "country", "postal_code", "city", "equipment"]
    ...
    def validate(self, data):
        ...
        country = data.get("country", None) if data.get("_country", None) is None else data.get("_country", None)
