    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_vehicle_type', models.CharField(blank=True, choices=[('PERSONENWAGEN', 'Personenwagen (maximum 5 inzittenden)'), ('MINIBUS', 'Minibus (maximum 8 inzittenden)'), ('VRACHTWAGEN', 'Vrachtwagen tot 3.5 ton (maximum 8 inzittenden)')], db_column='autotype', default='TemporaryVehicleInsurance.DEFAULT_VEHICLE_TYPE', max_length=30, null=True)),
                ...
                ('_vehicle_trailer', models.CharField(choices=[('0', 'Geen'), ('2', '<750kg'), ('3', '>750kg')], db_column='aanhangwagen', default='TemporaryVehicleInsurance.DEFAULT_VEHICLE_TRAILER_OPTION', max_length=1)),
            ],
            options={
