...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('_vehicle_type', scouts_auth.inuits.models.fields.django_shorthand_model_fields.DefaultCharField(blank=True, choices=[('PERSONENWAGEN', 'Personenwagen (maximum 5 inzittenden)'), ('MINIBUS', 'Minibus (maximum 8 inzittenden)'), ('VRACHTWAGEN', 'Vrachtwagen tot 3.5 ton (maximum 8 inzittenden)')], db_column='autotype', default='PERSONENWAGEN', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_vehicle_construction_year', scouts_auth.inuits.models.fields.django_shorthand_model_fields.OptionalIntegerField(blank=True, db_column='autobouwjaar', null=True, validators=[django.core.validators.MinValueValidator(1900)])),
                ('_vehicle_chassis_number', scouts_auth.inuits.models.fields.django_shorthand_model_fields.RequiredCharField(db_column='autochassis', max_length=20)),
                ('_vehicle_trailer', scouts_auth.inuits.models.fields.django_shorthand_model_fields.DefaultIntegerField(blank=True, choices=[('0', 'Geen'), ('1', 'Aanhangwagen')], db_column='aanhangwagen', default='0', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1)])),
