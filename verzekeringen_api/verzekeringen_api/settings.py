...
EMAIL_INSURANCE_REQUESTER_ADDRESS_DEBUG = env.str("EMAIL_INSURANCE_REQUESTER_ADDRESS_DEBUG", 'boro@inuits.eu')
EMAIL_INSURER_ADDRESS_DEBUG = env.str("EMAIL_INSURER_ADDRESS_DEBUG", 'boro@inuits.eu')
EMAIL_VICTIM_ADDRESS_DEBUG = env.str("EMAIL_VICTIM_ADDRESS_DEBUG", 'boro@inuits.eu')
EMAIL_DECLARANT_ADDRESS_DEBUG = env.str("EMAIL_DECLARANT_ADDRESS_DEBUG", 'boro@inuits.eu')
EMAIL_TEMPLATE = None
