...
BELGIAN_CITY_SEARCH_ENDPOINT = GROUP_ADMIN_BASE_URL + "/gis/gemeente?term=*"
...
RESOURCES_INSURANCES_TEMPLATE_PATH = RESOURCES_MAIL_TEMPLATE_PATH + env.str("RESOURCES_INSURANCES_TEMPLATE_PATH")
...
STORE_INSURANCE_CLAIM_REPORT_WHILE_DEBUGGING = env.bool("STORE_INSURANCE_CLAIM_REPORT_WHILE_DEBUGGING", False)
...
SENDINBLUE_TEMPLATE_INSURANCE_REQUESTER = 161
SENDINBLUE_TEMPLATE_INSURANCE_VICTIM = 162
SENDINBLUE_TEMPLATE_INSURANCE_DECLERANT = 163
SENDINBLUE_TEMPLATE_INSURANCE_INSURER = 164
...
EMAIL_INSURANCE_REQUESTER_ADDRESS_DEBUG = env.str("EMAIL_INSURANCE_REQUESTER_ADDRESS_DEBUG", EMAIL_DEBUG_RECIPIENT)
EMAIL_INSURER_ADDRESS_DEBUG = env.str("EMAIL_INSURER_ADDRESS_DEBUG", EMAIL_DEBUG_RECIPIENT)
EMAIL_VICTIM_ADDRESS_DEBUG = env.str("EMAIL_VICTIM_ADDRESS_DEBUG", EMAIL_DEBUG_RECIPIENT)
EMAIL_DECLARANT_ADDRESS_DEBUG = env.str("EMAIL_DECLARANT_ADDRESS_DEBUG", EMAIL_DEBUG_RECIPIENT)
EMAIL_TEMPLATE = None
