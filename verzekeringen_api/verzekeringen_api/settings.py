...
EMAIL_INSURANCE_REQUESTER_ADDRESS_DEBUG = env.str("EMAIL_INSURANCE_REQUESTER_ADDRESS_DEBUG", default=None)
EMAIL_INSURER_ADDRESS_DEBUG = env.str("EMAIL_INSURER_ADDRESS_DEBUG", default=None)
EMAIL_VICTIM_ADDRESS_DEBUG = env.str("EMAIL_VICTIM_ADDRESS_DEBUG", default=None)
EMAIL_DECLARANT_ADDRESS_DEBUG = env.str("EMAIL_DECLARANT_ADDRESS_DEBUG", default=None)
EMAIL_TEMPLATE = None
