...
#LOGGING_LEVEL_DB = env.str("LOGGING_LEVEL_DB", "ERROR")
...
KNOWN_PERSONNEL_GROUP = env.str("KNOWN_PERSONNEL_GROUP", "X1027G")
...
RESOURCES_MAIL_TEMPLATE_START = RESOURCES_MAIL_TEMPLATE_PATH + \
    env.str("RESOURCES_MAIL_TEMPLATE_START")
RESOURCES_MAIL_TEMPLATE_END = RESOURCES_MAIL_TEMPLATE_PATH + \
    env.str("RESOURCES_MAIL_TEMPLATE_END")
RESOURCES_INSURANCES_TEMPLATE_PATH = RESOURCES_MAIL_TEMPLATE_PATH + \
    env.str("RESOURCES_INSURANCES_TEMPLATE_PATH")
RESOURCES_CLAIMS_INSURER_TEMPLATE_PATH = RESOURCES_MAIL_TEMPLATE_PATH + env.str(
    "RESOURCES_CLAIMS_INSURER_TEMPLATE_PATH"
)
RESOURCES_CLAIMS_VICTIM_TEMPLATE_PATH = RESOURCES_MAIL_TEMPLATE_PATH + \
    env.str("RESOURCES_CLAIMS_VICTIM_TEMPLATE_PATH")
...
INSURANCE_EVENT_PARTICIPANT_LIST_FILES_BASE_PATH = env.str(
    "INSURANCE_EVENT_PARTICIPANT_LIST_FILES_BASE_PATH")
INSURANCE_EVENT_PARTICIPANT_LIST_FILE_NAME_PREFIX = env.str(
    "INSURANCE_EVENT_PARTICIPANT_LIST_FILE_NAME_PREFIX")
STORE_INSURANCE_CLAIM_REPORT_WHILE_DEBUGGING = env.bool(
    "STORE_INSURANCE_CLAIM_REPORT_WHILE_DEBUGGING", False)
...
EMAIL_INSURANCE_REQUESTER_ADDRESS_DEBUG = env.str(
    "EMAIL_INSURANCE_REQUESTER_ADDRESS_DEBUG", EMAIL_DEBUG_RECIPIENT)
EMAIL_INSURER_ADDRESS_DEBUG = env.str(
    "EMAIL_INSURER_ADDRESS_DEBUG", EMAIL_DEBUG_RECIPIENT)
EMAIL_VICTIM_ADDRESS_DEBUG = env.str(
    "EMAIL_VICTIM_ADDRESS_DEBUG", EMAIL_DEBUG_RECIPIENT)
EMAIL_DECLARANT_ADDRESS_DEBUG = env.str(
    "EMAIL_DECLARANT_ADDRESS_DEBUG", EMAIL_DEBUG_RECIPIENT)
EMAIL_TEMPLATE = None
